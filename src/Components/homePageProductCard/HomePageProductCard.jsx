                          ...
                          <div className="flex justify-center ">
                            {cartItems.some((p) => p.id === item.id) ? (
                              <button
                                ...
                                className=" bg-red-700 hover:bg-pink-600 w-full text-white py-[4px] rounded-lg font-bold transition-colors duration-200"
                              >
                                Delete From Cart
                              </button>
                            ) : (
                              <button
                                ...
                                className=" bg-pink-500 hover:bg-pink-600 w-full text-white py-[4px] rounded-lg font-bold transition-colors duration-200"
                              >
                                Add To Cart
                              </button>
                            )}
