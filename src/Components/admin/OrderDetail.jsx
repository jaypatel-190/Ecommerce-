  ...
  return (
    <div>
      <div>
        <div className="py-5">
          {/* text  */}
          <h1 className=" text-xl text-pink-300 font-bold" aria-label="All orders section heading">
            All Order
          </h1>
        </div>
                ...
                return (
                  <>
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <tr key={`${orderIndex}-${index}`} className="text-pink-300">
                          ...
                          <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-green-600 font-bold first:border-l-0 border-pink-100 stroke-slate-500 first-letter:uppercase ">
                            {order.status}
                          </td>
                    ...
                    <tr className="text-pink-300">
                      <td
                        colSpan="16"
                        className="h-12 px-6 text-md border-t border-l first:border-l-0 border-pink-100 text-slate-700 bg-slate-100 font-bold fontPara"
                      >
